...
export const Sidebar = () => {
  ...
  return (
    <div className="bg-white dark:text-[#c1c0c0] dark:bg-[#282828] dark:border-0 w-60 mx-6 rounded-2xl px-3 py-3 flex flex-col items-center h-full border border-gray-300">
