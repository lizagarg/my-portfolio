...
export const ProjectCard = ({ description, title, picture, skill1, skill2 }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white w-100 ml-4 px-5 py-1 rounded-2xl h-50 mb-4 border border-gray-300 cursor-pointer overflow-hidden transition duration-300 ease-in-out hover:scale-[1.02] hover:shadow-lg"
    >
